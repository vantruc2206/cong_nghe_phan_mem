...
class DroneModel(Base):
    ...
    ten_drone          = Column(String(100), nullable=True)
    model              = Column(String(100), nullable=True)
    tai_trong_toi_da   = Column(Numeric(5, 2), nullable=True, server_default='5.00')
    ...
    vi_do_hien_tai     = Column(Numeric(10, 7), nullable=True)
    kinh_do_hien_tai   = Column(Numeric(10, 7), nullable=True)
    ma_tram_hien_tai   = Column(UUID(as_uuid=True), nullable=True)
